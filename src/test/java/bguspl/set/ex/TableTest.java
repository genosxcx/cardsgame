...
class TableTest {
    ...
    void placeTokenTest() {
        fillSomeSlots();
        assertEquals(0, (int) table.tokensP[2][0]);
        assertNotEquals(1, (int) table.tokensP[2][0]);
        table.placeToken(0, 2);
        assertEquals(1, (int) table.tokensP[2][0]);
        assertNotEquals(0, (int) table.tokensP[2][0]);
    }
    
    @Test
    void removeCardTest() {
        fillSomeSlots();
        assertNotEquals(null, (Integer) slotToCard[2]);
        table.removeCard(2);
        assertEquals(null, (Integer) slotToCard[2]);
    }
}
